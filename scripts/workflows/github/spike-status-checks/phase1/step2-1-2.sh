...
../add-status-to-commit.sh $org $repo $commit "Build" "failure" "Build: Failed" $target_url
../add-status-to-commit.sh $org $repo $commit "Test" "pending" "Unit-Test: pending" $target_url